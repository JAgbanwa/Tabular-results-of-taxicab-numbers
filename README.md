...
[This folder](https://github.com/JAgbanwa/Tabular-results-of-taxicab-numbers/tree/main/Magma%20verification%20for%20a%20new%20family%20of%20solutions%20) contains a (tweakable) Magma code verifying the correctness of this other closed form generator of taxicab numbers below.

$A(c_1,m) = \frac{-2 \cdot 3^{m+1} + 3^m \cdot \left[(9 + \sqrt{3})(2+\sqrt{3})^{2c_1} + (9 - \sqrt{3})(2-\sqrt{3})^{2c_1}\right]}{4} + 3^{m+1}$

$B(c_1,m) = \frac{-2 \cdot 3^{m+2} + 3^{m} \cdot \left[(1 + 3\sqrt{3})(2+\sqrt{3})^{2c_1} - (3\sqrt{3}-1)(2-\sqrt{3})^{2c_1}\right]}{4}$

$C(c_1,m) = \frac{-2 \cdot 3^{m+1} + 3^m \cdot \left[(9 + \sqrt{3})(2+\sqrt{3})^{2c_1} + (9 - \sqrt{3})(2-\sqrt{3})^{2c_1}\right]}{4}$

$D(c_1,m) = \frac{-2 \cdot 3^{m+2} + 3^{m} \cdot \left[(1 + 3\sqrt{3})(2+\sqrt{3})^{2c_1} - (3\sqrt{3}-1)(2-\sqrt{3})^{2c_1}\right]}{4} + 3^{m+2}$
